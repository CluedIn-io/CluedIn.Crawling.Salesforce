...
namespace CluedIn.Crawling.Salesforce.Subjects
{
    public class AccountClueProducer : BaseClueProducer<Account>
    {
        ...
        protected override Clue MakeClueImpl(Account value, Guid id)
        {
            ...
            if (value.Phone != null) data.Properties[SalesforceVocabulary.Account.Phone] = value.Phone;
            ...
            if (value.PersonAssistantPhone != null) data.Properties[SalesforceVocabulary.Account.PersonAssistantPhone] = value.PersonAssistantPhone;
            ...
            if (value.PersonEmail != null) data.Properties[SalesforceVocabulary.Account.PersonEmail] = value.PersonEmail;
            ...
            if (value.PersonHomePhone != null) data.Properties[SalesforceVocabulary.Account.PersonHomePhone] = value.PersonHomePhone;
            ...
            if (value.PersonMobilePhone != null) data.Properties[SalesforceVocabulary.Account.PersonMobilePhone] = value.PersonMobilePhone;
            ...
            if (value.PersonOtherPhone != null) data.Properties[SalesforceVocabulary.Account.PersonOtherPhone] = value.PersonOtherPhone;
