...
{
    public class DuplicateEntityPrivateMobilePhoneQuery : IOnlineDuplicateEntityQuery
    {
        public string Name { get; } = "Private Mobile Phone";

        public string DisplayName { get; } = "Private Customer Mobile Phones";
