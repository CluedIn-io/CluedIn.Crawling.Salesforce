...
{
    public class DuplicateEntityBusinessWebsiteQuery : IOnlineDuplicateEntityQuery
    {
        public string Name { get; } = "Business Website";

        public string DisplayName { get; } = "Business Customer websites";
