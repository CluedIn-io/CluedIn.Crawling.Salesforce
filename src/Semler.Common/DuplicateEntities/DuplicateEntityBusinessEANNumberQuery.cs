...
{
    public class DuplicateEntityBusinessEANNumberQuery : IOnlineDuplicateEntityQuery
    {
        public string Name { get; } = "Business EAN Number";

        public string DisplayName { get; } = "Business Customer EAN numbers";
